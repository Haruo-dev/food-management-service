                        ...
                        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content ">
                                ...
                                <div class="modal-body">
                                    <!-- Formulario -->
                                        <form action="../class/insert_conductor.php?nom_user= <?php echo$nom_user?>&vista=1" class="m-lg-3" method="post">
                            ...
                            <tbody>
                                <?php
                                    for ($i=0; $i < count($reg); $i++) {
                                        ...
                                        ";
                                        $id = $reg[$i]['id_conductor'];
                                ?>
                                    <td align="center">
                                        <button class=" boton-eliminar boton-des blue" onclick=window.location="../class/editar_conductor.php?id=<?php echo $id;?>&vista=1&nom_user=<?php echo $nom_user;?>">
