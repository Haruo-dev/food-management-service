...
<body>
    <nav class="sidebar sidebar-traba">
        <header>
            ...
            <i class='bx bx-chevron-right toggle azul2'></i>
        </header>
                        ...
                        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content ">
                                ...
                                <div class="modal-body">
                                    <!-- Formulario -->
                                    <form action="../class/insert_cliente.php?nom_user= <?php echo$nom_user?>&vista=1" class="m-lg-3" method="post">
                    ...
                    <div class="table table-striped">
                        <table class="table table-striped table-hover" id="tabla">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <td align="center">
                                        <button class=" boton-eliminar boton-des blue" onclick=window.location="../class/editar_cliente.php?id=<?php echo $id?>&vista=1&nom_user=<?php echo $nom_user;?>">
