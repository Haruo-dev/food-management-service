                                            ...
                                            <table class="table table-striped table-hover id="table_id">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td align="center">
                                                            <button class=" boton-eliminar green"  onclick="habilitar('../class/deshabilitar_proveedor.php?nit=<?php echo $reg2[$i]['nit'];?>')">
                        ...
                        <tbody>
                            ...
                            ?>
                                <td align="center">
                                    ...
                                    <button class=" boton-eliminar blue" onclick=window.location="../class/editar_proveedor.php?nit=<?php echo $res[$i]['nit'];?>&vista=0&nom_user=<?php echo $nom_user;?>">
                                ...
                                <td align="center">
                                    ...
                                    <button class=" boton-eliminar"  onclick="deshabilitar('../class/deshabilitar_proveedor.php?nit=<?php echo $res[$i]['nit'];?>')">
