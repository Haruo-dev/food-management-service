                                    ...
                                    <div class="table table-striped">
                                        <table class="table table-striped table-hover id="table_id">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <td align="center">
                                                            <button class=" boton-eliminar green"  onclick="habilitar('../class/deshabilitar_ruta.php?cod=<?php echo $reg2[$i]['cod_ruta'];?>')">
                    ...
                    <div class="table table-striped">
                        <table class="table table-striped table-hover" id="tabla">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <td align="center">
                                        <button class=" boton-eliminar boton-des blue" onclick=window.location="../class/editar_ruta.php?cod=<?php echo $reg[$i]['cod_ruta'];?>&vista=0&nom_user=<?php echo $nom_user;?>">
                                    ...
                                    <td align="center">
                                        <button class=" boton-eliminar"  onclick="deshabilitar('../class/deshabilitar_ruta.php?cod=<?php echo $reg[$i]['cod_ruta'];?>')">
