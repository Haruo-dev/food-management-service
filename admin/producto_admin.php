                        ...
                        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content ">
                                ...
                                <div class="modal-body">
                                    <!-- Formulario -->
                                    <form action="../class/insert_productos.php?nom_user= <?php echo$nom_user?>&vista=0" class="m-lg-3" method="post">
                                            ...
                                            <table class="table table-striped table-hover id="table_id">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td align="center">
                                                            <button class=" boton-eliminar green"  onclick="habilitar('../class/desahabilitar_producto.php?cod=<?php echo $reg2[$i]['cod_producto'];?>')">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <td align="center">
                                        ...
                                        <button class=" boton-eliminar blue" onclick=window.location="../class/editar_producto.php?cod=<?php echo $reg[$i]['cod_producto'];?>&vista=0&nom_user=<?php echo $nom_user;?>">
                                    ...
                                    <td align="center">
                                        ...
                                        <button class=" boton-eliminar"  onclick="deshabilitar('../class/desahabilitar_producto.php?cod=<?php echo $reg[$i]['cod_producto'];?>')">
